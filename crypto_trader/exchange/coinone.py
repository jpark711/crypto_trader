...
class coinone(ccxt.pro.coinone):
    def __init__(self):
        super().__init__()
        self.tickers = None
        ...
        self.api_urls = {
            "order_books": None,
            "currencies": "https://api.coinone.co.kr/public/v2/currencies",
        }
        ...
        self.currency_types = {"withdraw": bool, "deposit": bool}
    ...
    def fetch_bid_ask(self, use_cached=False):
        ...
        for ticker, ticker_info in ticker_data.items():
            bid_ask_list = [
                ticker_info["info"]["best_bids"][0]["price"],
                ticker_info["info"]["best_bids"][0]["qty"],
                ticker_info["info"]["best_asks"][0]["price"],
                ticker_info["info"]["best_asks"][0]["qty"],
            ]
